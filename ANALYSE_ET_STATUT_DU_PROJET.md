...
| `web/supabase/migrations/007_first_question_passages.sql` | Deux passages pour la fiche classée première (retour arrière : réexécuter la fonction de 006) |
...
7. Appliquer dans l’ordre les migrations de `web/supabase/migrations/` (001 à 007, dans l’ordre) dans le projet Supabase prévu, après vérification de son état existant.
