...
async function main() {
  // Generated by scripts/refresh-corpus.py (not versioned).
...
main().catch(error => {
  console.error(
    error instanceof MissingCorpus ? error.message : "Audit interrompu : vérifier les connexions et la configuration.",
  );
  process.exitCode = 1;
});
