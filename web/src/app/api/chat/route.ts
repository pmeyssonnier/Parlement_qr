...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    while (true) {
      ...
      if (size > 16000) { await reader.cancel(); return fail("Message trop long.", 413); }
      parts.push(value);
    }
    ...
    return fail("Le service est momentanément indisponible. Vous pouvez consulter les sources et réessayer plus tard.", 503);
  }
}
